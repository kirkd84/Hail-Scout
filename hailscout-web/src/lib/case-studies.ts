...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    deck:
      "A four-truck Tornado Alley contractor swapped door-knocking guesswork for Hail GPS's polygon-grade hail data — and walked into the conference with the busiest spring of their decade.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Ridgeline started using Hail GPS the week after a March supercell dropped 2.5″ stones across Cleveland County. Mark dropped the company's monitored-address list — every customer, every warranty, every prior estimate — into the watchlist on a Sunday night.",
      ...
      },
      {
        ...
        paragraphs: [
          "Ridgeline closed a third of every estimate they wrote in May. Their inspection-to-contract conversion went from a national-average 18% to a Tornado-Alley-respectable 42%. They added a fifth truck in July, paid cash for it, and named her Hailey.",
          "More importantly, the team stopped resenting the route. The map was the route. Hail GPS told them where to go. The crew talked to homeowners who actually had damage, who actually wanted help, who actually wrote checks. Door-knocking stopped being a numbers game and started being a service.",
          "The conference-week email from Mark to his 14 friends in the trade said it best: Stop trying to remember which neighborhood got hit last March. Hail GPS remembers.",
        ],
      },
    ],
  },
