    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          <Link href="/live"     className="text-sm text-foreground">Live storms</Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/sign-up" className="inline-flex items-center gap-1 rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-atlas hover:bg-teal-900">
