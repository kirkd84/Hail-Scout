...
```json
{
  ...
  "type": "vector",
  "tiles": [
    "https://tiles.hailgps.com/swaths/{z}/{x}/{y}.pbf",
    "https://tiles.hailgps.com/historical/{date}/{z}/{x}/{y}.pbf"
  ],
  "minzoom": 4,
  "maxzoom": 14
}
...
- **URL:** `https://tiles.hailgps.com/swaths/{z}/{x}/{y}.pbf`
...
- **URL:** `https://tiles.hailgps.com/historical/{YYYY-MM-DD}/{z}/{x}/{y}.pbf`
...
const SwathsLayer = () => (
  <>
    <MapLibreGL.VectorSource
      id="swaths-source"
      tileUrlTemplates={["https://tiles.hailgps.com/swaths/{z}/{x}/{y}.pbf"]}
      minZoomLevel={4}
      maxZoomLevel={14}
    >
