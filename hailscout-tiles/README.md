...
[Upload] → s3://hailscout-tiles/
  ↓
CloudFront CDN → https://tiles.hailgps.com/swaths/{z}/{x}/{y}.pbf
```
...
```json
{
  "source": {
    "type": "vector",
    "tiles": ["https://tiles.hailgps.com/swaths/{z}/{x}/{y}.pbf"],
    "minzoom": 4,
    "maxzoom": 14
  }
}
...
- **Domain:** `tiles.hailgps.com` (via Route53 CNAME)
- **HTTPS:** ACM certificate for *.hailgps.com
